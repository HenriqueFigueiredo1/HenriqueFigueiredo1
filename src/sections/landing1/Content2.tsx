...
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module '../../assets/image/l1/jpg/cont... Remove this comment to see the full error message
import imgC from "../../assets/image/l1/jpg/content-1-img2.jpg";
// @ts-expect-error ts-migrate(2307) FIXME: Cannot find module '../../assets/image/l1/png/medi... Remove this comment to see the full error message
